...
//     const success = await login({ identifier, password: formData.password });
        ...
        if (response.status === 401) {
          ...
          if (data.status === 'PENDING') {
            toast({
              ...
              description: "Your account is awaiting admin approval. Please wait for confirmation.",
              variant: "destructive"
            });
            ...
            toast({
              title: "Access Denied",
              description: data.message || "Account access denied.",
              variant: "destructive"
            });
          }
        } else {
