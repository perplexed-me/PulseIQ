...
//         age: 0, // Default value, you might want to add this field to the form
//         gender: null, // Default value, you might want to add this field to the form
//         bloodGroup: null // Default value, you might want to add this field to the form
//       };
//       endpoint = 'http://localhost:8085/api/auth/register/patient';
...
//         phone: formData.phone,
//         password: formData.password,
//         specialization: '', // You might want to add this field to the form
//         degree: '', // You might want to add this field to the form
//         licenseNumber: '', // You might want to add this field to the form
//         assistantName: null,
//         assistantNumber: null,
//         consultationFee: null
//       };
//       endpoint = 'http://localhost:8085/api/auth/register/doctor';
...
//         specialization: '' // You might want to add this field to the form
//       };
//       endpoint = 'http://localhost:8085/api/auth/register/technician';
//     }
