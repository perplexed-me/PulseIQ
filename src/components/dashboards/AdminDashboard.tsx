...
//     }
//     try {
//       const resp = await fetch('http://localhost:8085/api/admin/pending', {
//         method: 'GET',
//         credentials: 'include',
//         headers: {
...
//     if (!token) return;
//     try {
//       const resp = await fetch('http://localhost:8085/api/admin/approved', {
//         method: 'GET',
//         credentials: 'include',
//         headers: {
//           Authorization: `Bearer ${token}`,
...
//     if (!token) return;
//     try {
//       const resp = await fetch('http://localhost:8085/api/admin/rejected', {
//         method: 'GET',
//         credentials: 'include',
//         headers: {
//           Authorization: `Bearer ${token}`,
...
//         `http://localhost:8085/api/admin/${action}/${userId}`,
//         {
//           method: 'POST',
//           headers: {
//             Authorization: `Bearer ${token}`,
...
//       // Re‐insert into the correct target array:
//       let moved: PendingUser | undefined = undefined;
//       moved =
...
//         };
//         if (action === 'approve') {
//           setApprovedUsers((prev) => [...prev, updated]);
//         } else {
//           setRejectedUsers((prev) => [...prev, updated]);
//         }
//       }
...
const AdminDashboard = () => {
  ...
  const fetchApprovedUsers = useCallback(async () => {
    ...
    if (!token) return;
    try {
      const resp = await fetch(`${BASE_URL}/api/admin/approved`, {
        method: 'GET',
        credentials: 'include',
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  const fetchRejectedUsers = useCallback(async () => {
    ...
    if (!token) return;
    try {
      const resp = await fetch(`${BASE_URL}/api/admin/rejected`, {
        method: 'GET',
        credentials: 'include',
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  const handleUserAction = async (
    ...
    try {
      ...
      const resp = await fetch(
        `${BASE_URL}5/api/admin/${action}/${userId}`,
        {
          method: 'POST',
          headers: {
            Authorization: `Bearer ${token}`,
