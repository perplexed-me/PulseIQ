...
public class UserServiceImpl implements UserService {
    ...
    public Map<String, Object> loginWithGoogleAsPatient(String idToken) {
        ...
        if (FirebaseApp.getApps().isEmpty()) {
            logger.warn("Firebase is not initialized. Google authentication is not available.");
            // Return an error response instead of throwing an exception
            Map<String, Object> errorResponse = new HashMap<>();
            errorResponse.put("error", "Google authentication is not available");
            errorResponse.put("message", "Firebase authentication service is not configured");
            throw new RuntimeException("Google authentication is not available");
        }
